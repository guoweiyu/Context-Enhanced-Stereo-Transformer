...
from dataset.middlebury import Middlebury2014Dataset,Middlebury2014Dataset1
...
def build_data_loader(args):
    ...
    if args.dataset == 'sceneflow':
        ...
        dataset_train = Middlebury2014Dataset1(dataset_dir, 'train')
        dataset_validation = Middlebury2014Dataset1(dataset_dir, args.validation)
        dataset_test = Middlebury2014Dataset1(dataset_dir, 'test')
    elif args.dataset == 'middlebury2014_test':
